...
import ba.unsa.etf.rpr.tutorijal5.util.KreditnaSposobnost;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        banka.kreirajNovogUposlenog("Marko", "Marić");
