...
public class GradController {
    ...
    public void clickOk(ActionEvent actionEvent) {
        ...
        if (cbOlimpijski.isSelected() && !choiceDrzava.getValue().isOlimpijska()){
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Greska!");
            alert.setHeaderText("Greška pri kreiranju grada");
            alert.setContentText("Država " + choiceDrzava.getValue().getNaziv() + " nije olimpijska država");
